	...
	<block>
		...
		<demo title="自定义">
			<div class="pagerout">
				<o-pager @next="onNext" :data="data" ref="pager2">
					...
					<div slot="done" gap="p15" color="desc">
						个心，某了，白刀子了
					</div>

					<div slot="loading" slot-scope="data" gap="p15" border>
		...
		<demo title="指令方式">
			<div class="pagerout" v-pager="vPager" :busy="busy">
				...
				<div v-if="data > 30" gap="p15" text="tc">数据已经全部加载</div>
				<div v-else>
